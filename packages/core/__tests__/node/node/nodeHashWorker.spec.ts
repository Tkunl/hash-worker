...
describe('NodeHashWorker', () => {
  ...
  beforeEach(() => {
    ...
    nodeUtils.readFileAsArrayBuffer.mockResolvedValue(new ArrayBuffer(1))
  ...
  describe('getFileHashChunks', () => {
    it('应该正确处理有效的文件路径', async () => {
      ...
      expect(result).toEqual({
        ...
        chunksHash: ['93b885adfe0da089cdf634904fd59f71'],
        merkleHash: '93b885adfe0da089cdf634904fd59f71',
    ...
    it('应该处理多个文件分片', async () => {
      ...
      expect(result.chunksHash.length).toBe(2)
    })
